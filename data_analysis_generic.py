...
SFac = 5 #Initial width diameter of bubble in cm
...
ax2.set_ylabel(r'$Diameter\;(pi)$', fontsize='12')
ax2.plot(d_v['Time(in milliseconds)']/1000, (d_v['D1'])*SFac, drawstyle = 'steps-post', label='$D1$', color='black')
ax2.plot(d_v['Time(in milliseconds)']/1000, (d_v['D2'])*SFac, drawstyle = 'steps-post', label='$D2$', color='red')
ax2.plot(d_v['Time(in milliseconds)']/1000, (d_v['D3'])*SFac, drawstyle = 'steps-post', label='$D3$', color='blue')
